                      ...
                      <tr key={work.id}>
                        ...
                        <td>
                          <div className="admin-table__actions">
                            <button className="btn-approve">민팅 허용</button>
